...
//		SearchForActions search = new DepthFirstSearch(new TreeSearch());
		...
		// Oops, need GS because space has loops (although not naturally infinite, hence DFS is complete w/ GS)
...
//		SearchForActions search = new SimulatedAnnealingSearch(new MaximumManhattanDistance(rubiksCube), sched);
		...
		// ... at least this works for r = 1, 2, 3, but not more!
//		SearchForActions search = new HillClimbingSearch(new CornerManhattanDistance(rubiksCube));

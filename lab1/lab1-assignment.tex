...
% In this lab, we will work on solving the Rubik's Cube puzzle with uninformed and informed search techniques.
...
% Note that 3D Manhattan distance alone is not admissible --- how should it be modified so that it is?
